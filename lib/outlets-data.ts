...
export const outletsData: Outlet[] = [
  ...
  },
  {
    number: 37,
    name: "Sli Mag",
    url: "https://slimag.com",
    category: "Lifestyle & Culture",
    description: "Modern lifestyle magazine covering trends and culture",
  },
  {
    number: 38,
    name: "Awesome",
  ...
  },
  {
    number: 41,
    name: "Pluralist",
    url: "https://pluralist.com",
    category: "Lifestyle & Culture",
    description: "Diverse perspectives on culture and lifestyle",
  },
  {
    number: 42,
    name: "US Features",
