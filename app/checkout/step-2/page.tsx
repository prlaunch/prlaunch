...
const categories = [
  {
    ...
    description: "For business owners, coaches, consultants",
    color: "purple",
  },
  {
    ...
    icon: "📈",
    title: "Finance",
    description: "For advisors, crypto, fintech",
    color: "cyan",
  },
  {
    ...
    icon: "✨",
    title: "Lifestyle",
    description: "For musicians, influencers, fashion, entertainment",
    color: "pink",
  },
  {
    id: "tech" as Category,
    ...
    description: "For marketers, startups, agencies",
    color: "purple",
  },
  {
    ...
    description: "For gyms, nutritionist, wellness, medical",
    color: "cyan",
  },
]
