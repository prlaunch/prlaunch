...
export default function Step5Page() {
  ...
  const displayPackages = authorityPackage ? [authorityPackage] : []
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container mx-auto px-4 max-w-2xl py-2.5" style={{ marginTop: "48px" }}>
        <div className="space-y-6">
          ...
          <div id="scroll-target-above" className="h-0" />

          <div ref={packagesRef} id="packages-target" className="-mt-20 pt-20" />
          ...
          <div className="space-y-6">
            {displayPackages.map((pkg) => {
              ...
              return (
                ...
                >
                  {pkg.bonus > 0 && (
                    <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-gradient-to-r from-black via-red-900 to-black text-white px-2.5 py-1 rounded-full text-[10px] font-bold shadow-xl flex items-center gap-1 z-20 whitespace-nowrap">
                  ...
                  <div className="bg-white rounded-2xl p-3.5">
                    ...
                    <div className="mb-3 space-y-2">
                      ...
                      >
                        ...
                        <span className="text-base font-semibold text-slate-600 tracking-tight">Claim now</span>
                      </div>
      ...
      {showScrollArrow && (
        <button
          ...
          className={`fixed bottom-4 right-6 z-40 bg-gradient-to-r from-blue-600 to-cyan-600 text-white p-3 rounded-full shadow-lg hover:shadow-xl hover:scale-110 transition-all duration-200 animate-in fade-in slide-in-from-bottom-4`}
