...
export default function TechnologyDigitalMarketingPage() {
  ...
  useEffect(() => {
    fetch("/api/outlets")
      .then((res) => res.json())
      .then((data) => {
        const filtered = data.filter((o: Outlet) => o.category === "Technology & Digital Marketing")
        setOutlets(filtered)
        setLoading(false)
      })
      .catch((err) => {
      ...
      <div className="bg-white border-b border-slate-200">
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              <h1 className="text-3xl md:text-4xl font-bold text-slate-900">Technology & Digital Marketing</h1>
